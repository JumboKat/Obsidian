...
Working off of the basic concept introduced previously, the two side magnets are replaced by two strong curved magnets, with a metal loop in the centre called an **armature**. The metal loop behaves like a flat magnet, with north and south pointing up and down. The armature spins until the opposite poles are lined up, and, like before, changing the direction of the current (by switching the wires) will keep the armature spinning.
